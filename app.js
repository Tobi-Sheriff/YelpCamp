...
mongoose.connect('mongodb://localhost:27017/yelp-campgronds', mongoAdd)
  .then(() => {
...
const store = new MongoDBStore({
    url: 'mongodb://localhost:27017/yelp-campgronds',
    secret,
    touchAfter: 24 * 60 * 60
});
...
//     console.dir(err);
//     //In a real app, we would do a lot more here...
//     return new ExpressError(`Cast to Object Failed... ${err.message}`, 400)
// }
